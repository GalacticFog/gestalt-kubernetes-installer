...
# \"gestalt.secrets.adminUser\": \"admin\", \"gestalt.secrets.adminPassword\": \"gestaltpoc!\", \"gestalt.secrets.databaseUsername\": \"secretdb\", \"gestalt.secrets.databasePassword\": \"secretpass\", 
# \"gestalt.secrets.adminUser\": \"passed.gestalt.secrets.adminUser\", \"gestalt.secrets.adminPassword\": \"passed.gestalt.secrets.adminPassword\", \"gestalt.secrets.databaseUsername\": \"passed.gestalt.secrets.databaseUsername\", \"gestalt.secrets.databasePassword\": \"passed.gestalt.secrets.databasePassword\", \"secrets.adminUser\": \"passed.secrets.adminUser\", \"secrets.adminPassword\": \"passed.secrets.adminPassword\", \"secrets.databaseUsername\": \"passed.secrets.databaseUsername\", \"secrets.databasePassword\": \"passed.secrets.databasePassword\", \"postgresql.postgresUser\": \"postgresqldb\", \"postgresql.postgresPassword\": \"postgresqlpass\"}"
mpdev /scripts/install --deployer="${DEPLOYER_TAG}" --parameters="{\"name\": \"${TEST_NAME}\", \"namespace\": \"${TEST_NAMESPACE}\", \"reportingSecret\": \"iweuniweubniewubn\", \"api.gateway.hostname\": \"api.zwobu.com\", \"logging.ingress.hostname\": \"logs.zwobu.com\", \"secrets.adminUser\": \"admin\", \"secrets.adminPassword\": \"gestaltpoc!\", \"secrets.databaseUsername\": \"postgres\", \"secrets.databasePassword\": \"abcd1234!\", \"postgresql.image\": \"postgres\", \"postgresql.postgresUser\": \"postgres\", \"postgresql.postgresPassword\": \"abcd1234!\"}"
