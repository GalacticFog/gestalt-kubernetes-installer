...
cat >> ${GENERATED_CONF_FILE} << EOF
    ...
    "KONG_IMAGE": "${docker_registry}/kong:${gestalt_kong_release_tag:-gestalt_docker_release_tag}",
    ...
    "POLICY_IMAGE": "${docker_registry}/gestalt-policy:${gestalt_policy_release_tag:-$gestalt_docker_release_tag}",
    ...
    "SECURITY_IMAGE": "${docker_registry}/gestalt-security:${gestalt_security_release_tag:-$gestalt_docker_release_tag}",
    "SECURITY_PORT": "9455",
